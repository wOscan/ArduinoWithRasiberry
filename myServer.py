...
binary_type_files = set(["jpg", "jpeg", "mp3", "png", "html", "js", "css","mp4"])
...
class HTTPServer:
    ...
    def __init__(self, host="192.168.3.23", port=9001, directory="."):
    ...
    def get_request(self, requested_file, data):
        # 我添加的
            ...
            if(requested_file == "sdata.js"):
                builder = ResponseBuilder()
                s =  'var data = {"tempurature":36,"shidu":90.0}'.encode("utf-8")
                builder.set_content(s)
